...
// File: contracts\openzeppelin-solidity\contracts\ownership\Claimable.sol
...
// File: contracts\openzeppelin-solidity\contracts\token\ERC20\SafeERC20.sol
...
// File: contracts\openzeppelin-solidity\contracts\ownership\CanReclaimToken.sol
...
// File: contracts\openzeppelin-solidity\contracts\ownership\HasNoTokens.sol
...
// File: contracts\openzeppelin-solidity\contracts\token\ERC20\PausableToken.sol
...
contract RewardToken is PausableToken, Whitelist, HasNoTokens {
    ...
    function getRewardTokenPercentage(uint256 _amount, uint256 _rewardPercentageIndex)
        internal
        view
        isValidRewardIndex(_rewardPercentageIndex)
        returns(uint256 _rewardPercentage)
    {
        _rewardPercentage = _amount.mul(rewardPercentage[_rewardPercentageIndex]).div(rewardPercentageDivisor);
    }
}

// File: contracts\TRVLToken.sol
